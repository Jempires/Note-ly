...
const newnotebtn = document.querySelector('');
/*function #1 """" create a new note button """"*/
newnotebtn.onclick = function() {
   /*opens text area to writing area*/
   /*ask nathan body structure*/
   /*ask nathan about returns from functions*/ 
   /*ask nathan or google where constant should be..in or out of function?*/   
}
